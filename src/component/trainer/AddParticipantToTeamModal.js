        ...
        return (
            ...
            (
                ...
                <Form noValidate validated={this.state.formValidated} onSubmit={this.handleSignUp}>
                    <Modal.Header>
                        {this.props.signUpMe ? <div>{t("sign_up_me_capital")}</div> : <div>{t("sign_up_participant_capital")}</div>}  
                    </Modal.Header>
                    <Modal.Body>                        
                            {!this.props.signUpMe && (
                                <Card>
                    ...
                    <Modal.Footer>
                        <div>
                            <Button variant="info" type="submit">{t("sign_up_simple")}</Button>{' '}                            
...
export default withTranslation()(AddParticipantToTeamModal);